...
1. Read the relevant [design module map](../../../docs/DESIGN.md#8-深模块与-library-first-边界) and active [decisions](../../../docs/DECISIONS.md). Use `rg` to locate duplicate policy, pass-through exports, compatibility branches, and callers.
