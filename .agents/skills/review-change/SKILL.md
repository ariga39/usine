...
3. **Design:** callers know only the boundary contract, policy has one owner, and no shallow or speculative seam was added. Require a separate design verdict only when [DEVELOPMENT review triggers](../../../docs/DEVELOPMENT.md#8-review-and-clean-room-direction-audits) apply.
